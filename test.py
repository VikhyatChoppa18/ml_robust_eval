...
print("MAE:", rm.mae_calc(y_true_reg, y_pred_reg))
print("MSE:", rm.mse_calc(y_true_reg, y_pred_reg))
print("R2 Score:", rm.r2_score_calc(y_true_reg, y_pred_reg))

print("\n=== NLP Metrics ===")
nlp = NLPMetricsCalc()
ref = "the quick brown fox"
cand = "the quick fox"
print("BLEU Score:", nlp.bleu_calc(ref, cand))

print("\n=== CV Metrics ===")
cv_m = CVMetricsCalc()
boxA = [0, 0, 2, 2]
boxB = [1, 1, 3, 3]
print("IoU:", cv_m.iou_calc(boxA, boxB))
...
print("\n=== A/B Testing ===")
tester = ABTesterTool()
result = tester.ab_testing(cm.accuracy_calc, [1,0,1], [1,0,0], [1,0,1], [1,1,1])
